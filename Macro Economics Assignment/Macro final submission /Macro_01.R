...
# plot states log per capita gdp 
plot(log10(Consumption_data$`Per capita GDP`),log10(Consumption_data$`Per capita Consumption`),xlim = c(4.2, 5.2), xlab = 'Log GDP per capita', ylab = 'Log Consumption per capita', main = 'Log Consumption per capita vs Log gdp per capita')
